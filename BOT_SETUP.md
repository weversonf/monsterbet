...
> **Dica:** o `ADMIN_TOKEN` pode ser qualquer texto seguro. Exemplo: `wevs2024monster!@#`
...
1. Use o arquivo `deploy_v3.zip` (ou gere um novo zip com `index.html`, `admin.html`, `netlify.toml`, `package.json` e a pasta `netlify/functions/`).
...
## 7. Painel admin no site

Acesse: `https://monsterbet.netlify.app/admin.html`

No login, use o **ADMIN_TOKEN** que você colocou nas variáveis de ambiente.
